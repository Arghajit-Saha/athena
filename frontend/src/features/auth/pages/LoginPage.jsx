    ...
    <AuthLayout mode="login">
      <form className="flex flex-col gap-6" id="login-form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer text-sm text-body select-none group" id="remember-me-label">
          ...
          <a href="#" className="text-sm font-semibold text-accent no-underline transition-colors duration-200 hover:text-accent-hover hover:underline" id="forgot-password-link">Forgot password?</a>
        </div>
